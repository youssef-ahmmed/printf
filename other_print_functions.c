...
int print_pointer(va_list args, params_t *params)
{
    ...
    address = convert_num_to_string(number, 16, CONVERT_UNSIGNED | CONVERT_LOWERCASE, params);
    *--address = 'x';
    *--address = '0';
...
int print_unsigned(va_list args, params_t *params)
{
    ...
    return (print_number(convert_num_to_string(long_number, 10, CONVERT_UNSIGNED, params), params));
}